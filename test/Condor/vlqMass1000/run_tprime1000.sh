...
let "sample=${1}+1"
cp /uscms_data/d3/tmitchel/Analysis2016/CMSSW_7_4_16_patch2/src/Analysis/VLQAna/test/Condor/vlqMass1000/tprime1000/tprime1000_${sample}.py .
...
rm hnpv*
rm os2lana*
xrdcp *.root root://cmseos.fnal.gov//store/user/tmitchel/condor/tprime1000
rm tpime1000_${sample}.py
rm *.root
ls
echo "DONE!"
