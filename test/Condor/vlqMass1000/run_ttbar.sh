...
let "sample=${1}+1"
cp /uscms_data/d3/tmitchel/76X_test/CMSSW_7_6_5/src/Analysis/VLQAna/test/Condor/vlqMass1000/ttbar/ttbar_${sample}.py .
...
rm scale*
rm os2lana*
xrdcp *.root root://cmseos.fnal.gov//store/user/tmitchel/condor/vlqMass1000/ttbar
rm ttbar_${sample}.py
rm *.root
ls
echo "DONE!"
