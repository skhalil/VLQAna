...
let "sample=${1}+1"
cp /uscms_data/d3/tmitchel/76X_test/CMSSW_7_6_5/src/Analysis/VLQAna/test/Condor/vlqMass1000/bprime1000/bprime1000_${sample}.py .
...
cmsRun bprime1000_${sample}.py
rm btag-eff-subjet.root
rm PU*
rm Run*
rm dataset*
rm os2lana*
xrdcp *.root root://cmseos.fnal.gov//store/user/tmitchel/condor/vlqMass1000/bprime1000
rm bprime1000_${sample}.py
rm *.root
ls
echo "DONE!"
