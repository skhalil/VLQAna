...
let "sample=${1}+1"
cp /uscms_data/d3/tmitchel/76X_test/CMSSW_7_6_5/src/Analysis/VLQAna/test/Condor/bZbH800/dy_HT400-600/dy_HT400-600_${sample}.py .
...
rm dataset*
rm os2lana*
xrdcp *.root root://cmseos.fnal.gov//store/user/tmitchel/condor/bZbH800/dy_HT400-600
