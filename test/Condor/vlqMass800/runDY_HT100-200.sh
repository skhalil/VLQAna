...
let "sample=${1}+1"
cp /uscms_data/d3/tmitchel/76X_test/CMSSW_7_6_5/src/Analysis/VLQAna/test/Condor/vlqMass800/dy_HT100-200/dy_HT100-200_${sample}.py .
...
rm dataset*
rm os2lana*
xrdcp *.root root://cmseos.fnal.gov//store/user/tmitchel/condor/vlqMass800/electron/dy_HT100-200
rm dy_HT100-200_${sample}.py
rm *.root
ls
echo "DONE!"
