...
let "sample=${1}+1"
cp /uscms_data/d3/tmitchel/Analysis2016/CMSSW_7_4_16_patch2/src/Analysis/VLQAna/test/Condor/vlqMass1200/DoubleMuon_05Oct/DoubleMuon_05Oct_${sample}.py .
...
cmsRun DoubleMuon_05Oct_${sample}.py
rm PU*
rm Run*
rm dataset*
rm hnpv*
rm os2lana*
xrdcp *.root root://cmseos.fnal.gov//store/user/tmitchel/condor/Dmu_05Oct
rm DoubleMuon_05Oct_${sample}.py
rm *.root
ls
echo "DONE!"
